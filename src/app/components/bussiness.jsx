  ...
  return (
    <div className="w-full min-h-screen bg-[#002035] text-white overflow-hidden">
      ...
      <div className="w-full bg-[#001F1B] text-sm">
        <div className="max-w-[1350px] mx-auto flex justify-between items-center px-8 py-3">
          ...
          <div className="flex gap-10 font-medium">
            <span className="cursor-pointer text-white/80 hover:text-white">
              Personal
            </span>
            <span className="cursor-pointer border-b-2 border-[#12B76A] pb-1 text-white">
              Business
            </span>
            <span className="cursor-pointer text-white/80 hover:text-white">
              Wholesale
          ...
          <div className="flex gap-8 items-center">
            ...
            <button className="border border-[#12B76A] px-3 py-1 rounded-md text-sm">
              EN ▾
            </button>
          </div>
        </div>
      ...
      <div className="w-full bg-[#003E30] border-t border-[#0a5c4a]">
        <div className="max-w-[1350px] mx-auto flex justify-between items-center px-8 h-[80px]">
          ...
          <div className="hidden lg:flex items-center gap-10 text-[17px] font-medium">
            ...
            <span className="text-[#12B76A] font-semibold cursor-pointer">
              Check your coverage
            </span>
          </div>
        </div>
      ...
      <section className="relative w-full bg-[#002035]">
        <div className="max-w-[1350px] mx-auto px-8 h-[82vh] flex items-center">
          <div className="grid grid-cols-1 lg:grid-cols-2 items-center w-full gap-4">
            ...
            <div className="max-w-[720px]">
              ...
              <button className="mt-10 bg-[#12B76A] hover:bg-[#0ea95f] transition px-10 py-4 rounded-full text-lg font-semibold flex items-center gap-3">
                <span className="text-xl">›</span>
                Learn more..
              </button>
            </div>

            {/* RIGHT IMAGE (CLOSE LIKE ORIGINAL) */}
        ...
        {/* LEFT SLIDER ARROW */}
        <div className="absolute left-6 top-1/2 -translate-y-1/2 text-white/60 text-3xl cursor-pointer hover:text-white">
          ‹
        </div>

        {/* RIGHT SLIDER ARROW */}
        <div className="absolute right-6 top-1/2 -translate-y-1/2 text-white/60 text-3xl cursor-pointer hover:text-white">
          ›
        </div>
      ...
      {/* ================= NEXIVO WIDGET (CORRECT WAY) ================= */}
      <Script
        src="https://widget.nexivo.dev.cognitry.io/scripts/corecognitics/d87bf5e2-46f7-4d41-a2bf-38984f9d29dd.js"
